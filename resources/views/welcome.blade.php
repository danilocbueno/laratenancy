        ...
        <div class="flex justify-center">
            <div class="max-w-[800px]">
                ...
                <p class="text-gray-500 text-lg">
                    Faça seu <a href="{{ route('tenant.create') }}" class="text-blue-600 hover:text-blue-700 transition duration-300 ease-in-out mb-4">cadastro</a>
                    ou <a href="{{ route('tenant.index') }}" class="text-blue-600 hover:text-blue-700 transition duration-300 ease-in-out mb-4">navegue nas lojas</a> cadastradas na plataforma
                </p>
            </div>
        </div>
