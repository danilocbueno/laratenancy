                ...
                <div class="container mx-auto px-6 w-full flex flex-wrap items-center justify-between">
                    ...
                    @auth
                        <div class="flex items-center relative">
                            ...
                            <!-- Shopping cart icon -->
                            <a class="text-gray-500 hover:text-gray-700 focus:text-gray-700 mr-4 dropdown-toggle hidden-arrow flex items-center" href="{{ route('cart.index') }}">
                                ...
                                @if(session()->has('cart'))
                                    <span class="text-white bg-red-700 absolute rounded-full text-xs -mt-2.5 ml-2 py-0 px-1.5">{{ count(session()->get('cart')) }}</span>
                                @endif
                            </a>
