    ...
    <div class="container mx-auto px-6 w-full flex flex-wrap items-center justify-between">
            ...
            <a class="navbar-brand text-dark-600" href="{{ route('front.store') }}">
                @if(tenant()->logo)
                    <img src="{{ tenant_asset(tenant()->logo) }}"
                         class="w-full hover:scale-110 transition duration-300 ease-in-out" alt="..."
                         style="object-fit: cover; max-height: 30px; max-width: 100px">
                @else
        ...
        <div class="navbar-collapse collapse grow items-center" id="navbarSupportedContentY">
            <ul class="navbar-nav mr-auto lg:flex lg:flex-row">
                <li class="nav-item">
                    <a class="nav-link block pr-2 lg:px-2 py-2 text-white hover:text-gray-400 focus:text-gray-700 transition duration-150 ease-in-out"
                       href="{{ route('admin.store.edit') }}">A loja</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link block pr-2 lg:px-2 py-2 text-white hover:text-gray-400 focus:text-gray-700 transition duration-150 ease-in-out"
                ...
                <li class="nav-item mb-2 lg:mb-0">
                    <a class="nav-link block pr-2 lg:px-2 py-2 text-white hover:text-gray-400 focus:text-gray-700 transition duration-150 ease-in-out"
                       href="{{ route('admin.store.payments') }}">Pedidos</a>
                </li>
            </ul>
        </div>
        @auth
            <div class="flex items-center relative">
                ...
                <!-- Notification icon -->
                <a class="text-white hover:text-gray-400 focus:text-gray-700 mr-4 dropdown-toggle hidden-arrow flex items-center"
                   href="#">
        ...
        @else
            <div class="flex items-center items-center lg:ml-auto">
                <a class="inline-block px-6 py-2.5 mr-2 bg-transparent text-blue-600 font-medium text-xs leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out"
                ...
                <a class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                   data-mdb-ripple="true" data-mdb-ripple-color="light" href="{{ route('register') }}">Registre-se</a>
            </div>
        @endauth
