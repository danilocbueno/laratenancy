<nav class="relative w-full flex flex-wrap items-center justify-between py-3 bg-gray-900 text-gray-200 shadow-lg navbar navbar-expand-lg navbar-light">
    <div class="container mx-auto px-6 w-full flex flex-wrap items-center justify-between">
        <div class="flex items-center">
            <button
                class="navbar-toggler border-0 py-3 lg:hidden leading-none text-xl bg-transparent text-gray-600 hover:text-gray-400 focus:text-gray-700 transition-shadow duration-150 ease-in-out mr-2"
                type="button"
        ...
        <div class="navbar-collapse collapse grow items-center" id="navbarSupportedContentY">
            <ul class="navbar-nav mr-auto lg:flex lg:flex-row">
                <li class="nav-item">
                    <a class="nav-link block pr-2 lg:px-2 py-2 text-white hover:text-gray-400 focus:text-gray-700 transition duration-150 ease-in-out" href="{{ route('admin.dashboard') }}">A loja</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link block pr-2 lg:px-2 py-2 text-white hover:text-gray-400 focus:text-gray-700 transition duration-150 ease-in-out" href="{{ route('admin.products.index') }}">Produtos</a>
                </li>
                <li class="nav-item mb-2 lg:mb-0">
                    <a class="nav-link block pr-2 lg:px-2 py-2 text-white hover:text-gray-400 focus:text-gray-700 transition duration-150 ease-in-out" href="{{ route('admin.categories.index') }}">Categorias</a>
                </li>
            </ul>
        </div>
        @auth
            <div class="flex items-center relative">
                ...
                <!-- Shopping cart icon -->
                <a class="text-white hover:text-gray-400 focus:text-gray-700 mr-4" href="{{ route('cart.index') }}">
                ...
                <!-- Notification icon -->
                <a class="text-white hover:text-gray-400 focus:text-gray-700 mr-4 dropdown-toggle hidden-arrow flex items-center" href="#">
        ...
        @else
            <div class="flex items-center items-center lg:ml-auto">
                <a class="inline-block px-6 py-2.5 mr-2 bg-transparent text-blue-600 font-medium text-xs leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out"  href="{{ route('login') }}">Login</a>
