    ...
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a class="navbar-brand text-dark-600" href="{{ route('front.store') }}">
                @if(tenant()->logo)
                <img src="{{ tenant_asset(tenant()->logo) }}" class="w-full hover:scale-110 transition duration-300 ease-in-out" alt="..." style="object-fit: cover; max-height: 30px; max-width: 100px">
                @else
